...
<div class="box">
<form name="changer">
  <select name="region" onchange="ajax_do('fixture-stats.php?d=store_region&x='+this.value);document.changer.reset();">
  ...
  <select name="district" onchange="ajax_do('fixture-stats.php?d=store_district&x='+this.value);document.changer.reset();">
