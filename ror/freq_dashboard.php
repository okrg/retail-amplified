...
<td class="col1">
	<ul>
   		<li><a href="#" id="dlatest" class="current" onclick="javascript:ajax_do('rt_dashlatest.php?mode=FREQ');return false;">Latest Responses</a></li>
		<li><a href="#" id="dnew" class="none" onclick="javascript:ajax_do('rt_dashdata.php?show=new&mode=FREQ');return false;">New</a></li>
		<li><a href="#" id="dopen" class="none" onclick="javascript:ajax_do('rt_dashdata.php?show=open&mode=FREQ');return false;">Open</a></li>
		<li><a href="#" id="dcompleted" class="none" onclick="javascript:ajax_do('rt_dashdata.php?show=completed&mode=FREQ');return false;">Recently Completed</a></li>
	</ul>
</td>
<td class="col2">
...
<td class="col3">
	<div id="quickreport">
	<form action="report_engine.php?mode=FREQ" name="quickreport" method="POST">
