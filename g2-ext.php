...
$vendormatch = mysql_result($cr, 0, "company_name");

//Determine total number of records
$result = mysql_query("select id from repair_orders where $view_restrictions and parent = 0 and vendor = '$vendormatch'");
...
<?php 
if (!$reporting_mode) {
	$sql = "select id, project_id, store_number, store_district, store_region, priority, timestamp, issue_date, type, status from repair_orders where $view_restrictions and parent = 0 and vendor = '$vendormatch' $filter_sql";
	...
	$sql .= ") AND parent = 0 and vendor = '$vendormatch'";
	} else {
	$sql .= "id>0) AND parent = 0 and vendor = '$vendormatch'";
	}
