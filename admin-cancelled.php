...
<div id="content">
<h1>:: Cancelled Companies</h1>
<div class="databox">
<div align="center"><img src="images/usergroup.gif" /></div>
<p>List of Cancelled Companies the Database</p>
<p>[<a href="index.php?page=admin-companies">Go to List of Active companies</a>]</p>
<?php

dbconnect();

//Create list of companies
	$sql = "select * from companies where active = 0 order by company_name";
...
if (mysql_num_rows($result)>0){
	...
	print "<p>No cancelled companies to list.</p>";
}
