...
<?php 
   ...
   <td class="project <?=$displayclass?>" data-id="<?=$store['id']?>" data-storename="<?=$store['store_number']?> <?=$store['data']['sitename']?>">	
	...
	<div class="line split">
	<div class="date" data-field="a-rec_approved" data-init-value="<?=dateFormat($store['actual']['rec_approval'])?>"><?=dateFormat($store['actual']['rec_approval'])?></div>
	...
	<div class="line split">
	<div data-field="p-project_type" data-init-value="<?=ucfirst($store['data']['project_type'])?>" class="string"><?=ucfirst($store['data']['project_type'])?></div>
	...
	<div class="line">
	<div class="dropdown" data-field="p-landlord_approval_required_for_permit" data-init-value="<?=$store['data']['landlord_approval_required_for_permit']?>"><?=$store['data']['landlord_approval_required_for_permit'] == 1 ? 'Yes' : 'No' ?></div>
	</div>

	<div class="line arch-line split">
	<div class="string" data-field="s-permit_duration" data-init-value="<?=$store['scheduled']['permit_duration']?>"><?=$store['scheduled']['permit_duration']?></div>
	<div class="string" data-field="a-permit_duration" data-init-value="<?=$store['actual']['permit_duration']?>"><?=$store['actual']['permit_duration']?></div>
	</div>
	...
	<div class="string" data-field="p-bldg_dept_comments_rcvd" data-init-value="<?=$store['data']['bldg_dept_comments_rcvd']?>"><?=$store['data']['bldg_dept_comments_rcvd']?></div>
	</div>
	...
	<div class="line">
	<div class="string" data-field="p-duration" data-init-value="<?=$store['data']['duration']?>"><?=$store['data']['duration']?></div>
	</div>
