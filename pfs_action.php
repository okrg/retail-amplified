...
if(isset($_POST["action"]))
{
 ...
 {  
  $glob_path = realpath(dirname(__FILE__))."/files/$project_id/*";
  $folder = array_filter(glob($glob_path), 'is_dir');
 ...
 {
  if(!file_exists(realpath(dirname(__FILE__))."/files/$project_id/".$_POST["folder_name"])) 
  {
   mkdir(realpath(dirname(__FILE__))."/files/$project_id/".$_POST["folder_name"], 0777, true);
   echo 'Folder Created';
  }
  else
  {
