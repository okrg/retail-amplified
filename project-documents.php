...
<h1>:: Misc. Documents</h1>
<div class="databox">
<p>Other miscellaneous documents associated with this store.</p>
<?php
...
if (count($files) > 0) { //if no files, dont show table!
...
?>	
	...
	<p>Add a <strong>single file</strong> to the misc folder. Only corp team and GDA will be able to see these files.</p>
